      ...
      <svg :width="svgWidth" :height="svgHeight">
        <g :transform="`translate(${margin.left}, ${margin.bottom})`" class="the-group">
          ...
          >
            ...
            <path :class="[setShown === 1 ? 'area-three' : 'area-three-100']" :d="paths.areaThree" />
    ...
    <section class="text-section" id="sectionsOne">
      ...
      <div class="text-box">
        ...
        <p>
          ...
          <span class="datum">25%</span> over the last 30
          years.
        </p>
      </div>
      <div class="text-box">
        ...
        <p>
          ...
          </span>, with some water coming from beyond the country's borders like from Canada marked as
          <span
      ...
      <div class="text-box">
        ...
        <p>
          ...
          <a
            ...
            target="_blank"
          >water usage data</a> for the
          country. As of
          <span class="datum">2015</span>, the allocation of withdrawn freshwater
